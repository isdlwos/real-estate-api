...
export class InitialSchema1781258399113 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "favorites" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "propertyId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_f9c880e929c6fa3bdb17c3f6d12" UNIQUE ("userId", "propertyId"), CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'agent', 'client')`);
        ...
        await queryRunner.query(`CREATE TABLE "agents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bio" text, "licenseNumber" character varying, "agency" character varying, "userId" uuid NOT NULL, CONSTRAINT "REL_f535e5b2c0f0dc7b7fc656ebc9" UNIQUE ("userId"), CONSTRAINT "PK_9c653f28ae19c5884d5baf6a1d9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "property_images" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "url" character varying NOT NULL, "isPrimary" boolean NOT NULL DEFAULT false, "propertyId" uuid NOT NULL, CONSTRAINT "PK_317c3774ee70c26d70c4f80e200" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."properties_type_enum" AS ENUM('sale', 'rent')`);
        await queryRunner.query(`CREATE TYPE "public"."properties_category_enum" AS ENUM('apartment', 'house', 'land', 'commercial')`);
        await queryRunner.query(`CREATE TYPE "public"."properties_status_enum" AS ENUM('draft', 'available', 'sold', 'rented')`);
        ...
        await queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "FK_3e8d0ebc5826f09dc33013df971" FOREIGN KEY ("agentId") REFERENCES "agents"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "appointments" DROP CONSTRAINT "FK_3e8d0ebc5826f09dc33013df971"`);
